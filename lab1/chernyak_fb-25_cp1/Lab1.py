...
def calculate_frequencies(text, overlap):
    ...
    return letter_freq, bigram_matrix, alphabet
...
def main():
    ...
    letter_freq_with_spaces, bigram_matrix_overlap_with_spaces, alphabet_with_spaces = calculate_frequencies(
        cleaned_text_with_spaces, overlap=True)
    _, bigram_matrix_non_overlap_with_spaces, _ = calculate_frequencies(cleaned_text_with_spaces, overlap=False)

    letter_freq_without_spaces, bigram_matrix_overlap_without_spaces, alphabet_without_spaces = calculate_frequencies(
        cleaned_text_without_spaces, overlap=True)
    _, bigram_matrix_non_overlap_without_spaces, _ = calculate_frequencies(cleaned_text_without_spaces, overlap=False)
    ...
    H_max_with_spaces = log2(len(alphabet_with_spaces))
    H_max_without_spaces = log2(len(alphabet_without_spaces))

    redundancy_H1_with_spaces = redundancy(H1_with_spaces, H_max_with_spaces)
    redundancy_H2_overlap_with_spaces = redundancy(H2_overlap_with_spaces, H_max_with_spaces)
    redundancy_H2_non_overlap_with_spaces = redundancy(H2_non_overlap_with_spaces, H_max_with_spaces)

    redundancy_H1_without_spaces = redundancy(H1_without_spaces, H_max_without_spaces)
    redundancy_H2_overlap_without_spaces = redundancy(H2_overlap_without_spaces, H_max_without_spaces)
    redundancy_H2_non_overlap_without_spaces = redundancy(H2_non_overlap_without_spaces, H_max_without_spaces)
    ...
    print(
        f"H2 (ентропія біграм без перетину): {H2_non_overlap_with_spaces}, R: {redundancy_H2_non_overlap_with_spaces}")
    ...
    print(
        f"H2 (ентропія біграм без перетину): {H2_non_overlap_without_spaces}, R: {redundancy_H2_non_overlap_without_spaces}")
    ...
    save_to_csv(bigram_matrix_non_overlap_with_spaces, "bigram_matrix_non_overlap_with_spaces.csv",
                index_label="Перша літера")
    save_to_csv(letter_freq_without_spaces, "letter_frequencies_without_spaces.csv", index_label="Літера",
                columns_label="Частота")
    save_to_csv(bigram_matrix_overlap_without_spaces, "bigram_matrix_overlap_without_spaces.csv",
                index_label="Перша літера")
    save_to_csv(bigram_matrix_non_overlap_without_spaces, "bigram_matrix_non_overlap_without_spaces.csv",
                index_label="Перша літера")
